  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between-items-center max-w-7xl max-auto'>
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Mohamed &lt; <span className='sm:block hidden'> Frontend Developer</span>&gt;</p>
          </Link>
          ...
          {/* <div className='sm:hidden flex flex-1 justify-end items-center'>
              <img src={"menu.svg"} alt="menu" className='w-[28px] h-[28px] object-contain cursor-pointer' onClick={()=>setToggle(!toggle)} />
          </div> */}
      </div>
    </nav>
